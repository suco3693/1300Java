...
public class SoundToneGame
{
    ...
    private void createGameTones()
    {
        ...
        {
          gameTones[i]=new SoundTone(440+30*i,1,2);
        }
    ...
    private void playHighTone()
    {
        // play the tone that indicates the user guess was too high
         SoundTone high=new SoundTone(4000,1,2);
         high.playTone();
         SoundTone blank =new SoundTone(400,2,0);
         blank.playTone();
    }
    ...
    private void playWinFanfare() 
    {
      ...
      SoundTone wff1=new SoundTone(1000,1,2);
      SoundTone wff2=new SoundTone(1500,1,2);
      SoundTone wff3=new SoundTone(2000,1,2);
      wff1.playTone();
      wff2.playTone();
      wff3.playTone();
    }
    ...
    private void playLoseFanfare() 
    {
      ...
      SoundTone wlf1=new SoundTone(1000,1,2);
      SoundTone wlf2=new SoundTone(500,1,2);
      SoundTone wlf3=new SoundTone(200,1,2);
      wlf1.playTone();
      wlf2.playTone();
      wlf3.playTone();
    }
